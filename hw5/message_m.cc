...
rMessage::rMessage(const char *name, short kind) : ::omnetpp::cMessage(name,kind)
{
    this->startTime = 0;
    this->tmpStartTime = 0;
}

rMessage::rMessage(const rMessage& other) : ::omnetpp::cMessage(other)
{
    copy(other);
}
...
void rMessage::copy(const rMessage& other)
{
    ...
    this->tmpStartTime = other.tmpStartTime;
}
...
void rMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->tmpStartTime);
}
...
void rMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->tmpStartTime);
}

::omnetpp::simtime_t rMessage::getStartTime() const
{
    return this->startTime;
}

void rMessage::setStartTime(::omnetpp::simtime_t startTime)
{
    this->startTime = startTime;
}

::omnetpp::simtime_t rMessage::getTmpStartTime() const
{
    return this->tmpStartTime;
}

void rMessage::setTmpStartTime(::omnetpp::simtime_t tmpStartTime)
{
...
rMessageDescriptor::rMessageDescriptor() : omnetpp::cClassDescriptor("rMessage", "omnetpp::cMessage")
{
...
int rMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "tmpStartTime")==0) return base+1;
...
std::string rMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return simtime2string(pp->getTmpStartTime());
        default: return "";
    }
}
...
bool rMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setTmpStartTime(string2simtime(value)); return true;
